...
class ActivoExtintor(models.Model):
    ...
    pesoExtintor=models.CharField(max_length=3, verbose_name="Peso del Extintor")
    fechaUltimaRecarga=models.DateField(verbose_name="Fecha Ultima Recarga", help_text="DD/MM/AAAA", default=date.today)
    fechaIngresoExtintor=models.DateField(verbose_name="Fecha de Ingreso", help_text="DD/MM/AAAA", default=date.today)
...
class ActivoEquipoOficina(models.Model):
    ...
    ramEquipo=models.CharField(max_length=20, verbose_name="Ram del Equipo", blank=True, default='No Aplica')
    memoriaEquipo=models.CharField(max_length=20, verbose_name="Memoria del Equipo", blank=True, default='No Aplica')
    ubicacionEquipo=models.CharField(max_length=50, verbose_name="Ubicación del Equipo")
    fechaIngresoEquipo=models.DateField(verbose_name="Fecha de Ingreso", help_text="DD/MM/AAAA", default=date.today)

    # fechaProximaRevision=models.DateField(verbose_name="Fecha Proxima Revisión", help_text="DD/MM/AAAA", default=date.today)
    componentesAdicionales=models.TextField(max_length=200, verbose_name="Componentes del Equipo", blank=True)
