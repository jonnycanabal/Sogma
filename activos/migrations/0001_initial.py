    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sistemaOperativo', models.CharField(default='No Aplica', max_length=20, verbose_name='Sistema Operativo')),
                ('ramEquipo', models.CharField(default='No Aplica', max_length=20, verbose_name='Ram del Equipo')),
                ('memoriaEquipo', models.CharField(default='No Aplica', max_length=20, verbose_name='Memoria del Equipo')),
